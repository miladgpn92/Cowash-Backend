...
namespace Web.Pages.DTCMS.Product
{
    ...
    public class UpsertModel : PageModel
    {
        ...
        public UpsertModel(IRepository<Entities.Product> repository, ISlugService<Entities.Product> slugService, IMapper mapper)
        {
        ...
        [BindProperty]
        public ProductDto? Items { get; set; } = new();
        ...
        public async Task OnGetAsync(int? id, bool? IsReturn, CancellationToken cancellationToken)
        {
            ...
            if (id.HasValue)
            {
                ...
                Items = await _repository.TableNoTracking.ProjectTo<ProductDto>(Mapper.ConfigurationProvider)
        ...
        public async Task<IActionResult> OnPostAsync(CancellationToken cancellationToken)
        {
            ...
            if (IsEdit)
            {
                ...
                {
                    return Redirect($@"/product/{HttpUtility.UrlEncode(model.Slug)}");
                }
