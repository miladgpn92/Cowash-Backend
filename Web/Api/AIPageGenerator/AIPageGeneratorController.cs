...
namespace Web.Api.AIPageGenerator
{
    ...
    public class AIPageGeneratorController : BaseController
    {
        ...
        public AIPageGeneratorController(IAIService aiService, IGlobalSettingService GlobalSettingService, IDynamicPageService DynamicPageService , ISlugService<Entities.DynamicPage> SlugService , UserManager<ApplicationUser> UserManager)
        {
