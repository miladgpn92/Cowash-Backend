...
namespace Web.Pages.DTCMS.ProductCategory
{
    ...
    public class UpsertModel : PageModel
    {
        ...
        public UpsertModel(IRepository<Entities.ProductCategory> repository, ISlugService<Entities.ProductCategory> slugService, IMapper mapper)
        {
        ...
        [BindProperty]
        public ProductCategoryDto? Items { get; set; } = new();
        ...
        public async Task OnGetAsync(int? id, CancellationToken cancellationToken)
        {
            if (id.HasValue)
            {
                ...
                Items = await _repository.TableNoTracking.ProjectTo<ProductCategoryDto>(Mapper.ConfigurationProvider)
